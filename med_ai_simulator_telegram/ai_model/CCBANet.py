...
from ai_model.modules import ASM,CCM,BAM,SELayer
...
class CCBANet(nn.Module):
    def __init__(self, num_classes):
        ...
        resnet.load_state_dict(torch.load('/home/otabek.nazarov/Downloads/hc701/assignment4/resnet34-333f7ec4.pth'))
